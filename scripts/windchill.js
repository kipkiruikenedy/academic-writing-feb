...
const url =
  "https://api.openweathermap.org/data/2.5/weather?q=California,UnitedStates&appid=3b2ef76d25ad22a05fcfd9aeead6bddb&units=metric";
...
function windChillCalc() {
  ...
  const windSpeedMsec = parseFloat(
